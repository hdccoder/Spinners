...
const ProfileSettings = ({ user, setUser }) => {
    ...
    return (
      <Box sx={{ flexGrow: 1, p: "1rem" }}>
        ...
        <List>
          ...
          <Button variant="contained" onClick={() => setDisplayField(false)}>
            Edit
          </Button>
          <Button
            variant="text"
            sx={{ fontWeight: 700, float: "right", color: "primary.dark" }}
            onClick={() => {
  ...
  const profileUserAddress = () => {
    return (
      <Box sx={{ flexGrow: 1, p: "1rem", maxWidth: "50%" }}>
        <Typography variant="h5">Customer Address & Phone</Typography>
        ...
        <Button variant="contained" onClick={() => setDisplayAddress(false)}>
          Edit
        </Button>
      </Box>
    );
  ...
  const updateUserAddress = () => {
    return (
      <Box sx={{ flexGrow: 1, p: "1rem" }}>
        <Typography variant="h5">Edit Address & Phone</Typography>
