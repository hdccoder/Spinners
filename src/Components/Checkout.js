...
function getStepContent(step, orderDetails, placeOrder, user) {
  switch (step) {
    case 0:
    ...
    case 1:
      return <PaymentForm />;
    case 2:
      return <ProductsReview orderDetails={orderDetails}/>
    default:
      throw new Error('Unknown step');
  }
}
//add the input props from home and pass it down to AddressForm
export default function Checkout ({ getItemsInCart, placeOrder,  user}) {
        ...
        <Paper variant="outlined" sx={{ my: { xs: 3, md: 6 }, p: { xs: 2, md: 3 } }}>
          ...
          {activeStep === steps.length ? (
            ...
            <Container component={"form"} onSubmit={handleNext}>              
              {getStepContent(activeStep, orderDetails, placeOrder, user)}
